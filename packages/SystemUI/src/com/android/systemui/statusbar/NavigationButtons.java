...
public class NavigationButtons {
    ...
    public static final ButtonInfo BACK =  new ButtonInfo(
            ...
            R.drawable.ic_sysbar_back_land, R.drawable.ic_sysbar_back, BACK_STRING);
    public static final ButtonInfo SEARCH = new ButtonInfo(
            ...
            R.drawable.ic_sysbar_search_land, R.drawable.ic_sysbar_search, SEARCH_STRING);
    public static final ButtonInfo RECENT =  new ButtonInfo(
            ...
            R.drawable.ic_sysbar_recent_land, R.drawable.ic_sysbar_recent, RECENT_STRING);
    public static final ButtonInfo EMPTY = new ButtonInfo(
            ...
            R.drawable.ic_sysbar_add_land, R.drawable.ic_sysbar_add, EMPTY_STRING);
